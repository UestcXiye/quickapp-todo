...
const { readJson, colorconsole, KnownError } = require('@hap-toolkit/shared-utils')
 ...
 * 使用 node 原生模块给予警告
 */
exports.checkBuiltinModules = function checkBuiltinModules(packageJson, request, callback) {
