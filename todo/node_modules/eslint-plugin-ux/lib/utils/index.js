...
const vueEslintParser = require('./ux-eslint-parser')
...
module.exports = {
   ...
   * If the parser service of `ux-eslint-parser` was not found,
  ...
  defineTemplateBodyVisitor (context, templateBodyVisitor, scriptVisitor) {
    if (context.parserServices.defineTemplateBodyVisitor == null) {
      context.report({
        loc: { line: 1, column: 0 },
        message: 'Use the latest ux-eslint-parser. See also https://eslint.vuejs.org/user-guide/#what-is-the-use-the-latest-ux-eslint-parser-error'
      })
      return {}
    }
